            ...
            <div class="row">
                <div class="col-xs-3">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="appname" placeholder="${I18n.system_please_input}服务名称" >
                    </div>
                </div>
                <div class="col-xs-3">
                    <div class="input-group">
			            ...
			            <div class="box-body">
			              	<table id="jobgroup_list" class="table table-bordered table-striped display" width="100%" >
				                <thead>
					            	<tr>
                                        <th name="id" >ID</th>
                                        <th name="appName" >服务名称</th>
                                        <th name="appDesc" >${I18n.jobgroup_field_title}</th>
                                        <th name="addressList" >OnLine ${I18n.jobgroup_field_registryList}</th>
                ...
                <div class="modal-body">
                    <form class="form-horizontal form" role="form" >
                        <div class="form-group">
                            <label for="lastname" class="col-sm-2 control-label">服务名称<font color="red">*</font></label>
