...
<#--					                	<th name="jobGroup" >${I18n.jobinfo_field_jobgroup}</th>-->
					                  	<th name="jobName" >${I18n.jobinfo_field_jobdesc}</th>
					                  	<th name="cronExpression" >${I18n.jobinfo_field_cronExpression}</th>
					                  	<th name="status" >${I18n.system_status}</th>
					                  	<th name="concurrent" >${I18n.jobinfo_field_concurrent}</th>
					                  	<th name="misfirePolicy" >${I18n.jobinfo_field_misfirePolicy}</th>
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
                    ...
                    <div class="form-group">
                        <label for="firstname" class="col-sm-2 control-label">${I18n.jobinfo_field_jobgroup}<font color="red">*</font></label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="executorHandler" placeholder="${I18n.system_please_input}JobHandler" maxlength="100" >
                        </div>
                    </div>

                    <#-- 任务服务名称 -->
                    <div class="form-group">
                        <label for="firstname" class="col-sm-2 control-label">${I18n.jobinfo_field_jobservername}<font color="red">*</font></label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="jobGroup" placeholder="${I18n.system_please_input}${I18n.jobinfo_field_jobservername}" maxlength="100" >
                        </div>
                    </div>

                    <#-- 任务服务地址 -->
                    <div class="form-group">
                        <label for="firstname" class="col-sm-2 control-label">${I18n.jobinfo_field_jobserveradress}<font color="red">*</font></label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="jobServerId" placeholder="${I18n.system_please_input}${I18n.jobinfo_field_jobserveradress}" maxlength="100" >
                        </div>
                    </div>

                    <#-- Cron表达式 -->
                    <div class="form-group">
                        <div class="schedule_conf cronExpression" >
                            <label for="lastname" class="col-sm-2 control-label">Cron表达式<font color="red">*</font></label>
                            <div class="col-sm-4"><input type="text" class="form-control" name="cronExpression" placeholder="${I18n.system_please_input}Cron" maxlength="128" ></div>
                        </div>
                        <div class="schedule_conf schedule_conf_FIX_RATE" style="display: none" >
                            <label for="lastname" class="col-sm-2 control-label">${I18n.schedule_type_fix_rate}<font color="red">*</font></label>
                            <div class="col-sm-4"><input type="text" class="form-control" name="schedule_conf_FIX_RATE" placeholder="${I18n.system_please_input} （ Second ）" maxlength="10" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" ></div>
                    ...
                    <#-- 任务描述 -->
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_jobdesc}<font color="black">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="jobName" placeholder="${I18n.system_please_input}${I18n.jobinfo_field_jobdesc}" maxlength="50" ></div>
                    </div>

                    <#-- 是否并发 -->
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_concurrent}<font color="black">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="concurrent" placeholder="${I18n.system_please_input}${I18n.jobinfo_field_concurrent}" maxlength="50" ></div>
                    </div>

                    <#-- 策略 -->
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_misfirePolicy}<font color="black">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="misfirePolicy" placeholder="${I18n.system_please_input}${I18n.jobinfo_field_misfirePolicy}" maxlength="50" ></div>
                    </div>

                    <#-- 任务状态 -->
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_jobstate}<font color="black">*</font></label>
                        <div class="col-sm-4">
<#--                            <input type="text" class="form-control" name="status" placeholder="${I18n.system_please_input}${I18n.jobinfo_field_jobstate}" maxlength="50" >-->
                            <div class="material-switch pull-left">
                                <input id="switch-status" onclick="selectCheckbox(this)" type="checkbox" />
                                <label for="switch-status" class="label-success"></label>
                            </div>
                        </div>
                        <input id="status" type="text" style="display: none" value="" />
                    </div>
