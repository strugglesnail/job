...
public class JobServerService {
	private static Logger logger = LoggerFactory.getLogger(JobServerService.class);
	...
	public Map<String, Object> pageList(JobServerRequest request) {
		...
		// page list
		List<JobServer> dataList = jobServerMapper.listLikePage(server, request.getRowBounds());
		Long count = jobServerMapper.countLike(server);
//
		// package result
	...
	public JobServer loadById(int serverId) {
		JobServer jobServer = jobServerMapper.getById(serverId);
		return jobServer;
	}

	
	public ReturnT<String> add(JobServer jobServer) {

		// valid base
//		JobServer group = xxlJobGroupDao.load(jobInfo.getJobGroup());
//		if (group == null) {
...
//		}
	...
	public ReturnT<String> update(JobServer jobInfo) {
